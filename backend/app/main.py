...
from app.models import alert, alert_event, asset, audit, batch_exec, container, deploy, patrol, rbac, ticket, user, system_config, monitoring, ssh_key, scheduled_task  # noqa: F401
