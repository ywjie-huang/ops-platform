    ...
    children: [
      {
        ...
        meta: { title: '主机管理', permission: 'assets.view' },
      },
      {
        path: ':id',
        name: 'AssetDetail',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '角色权限', permission: 'roles.view' },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '监控指标', permission: 'monitoring.view' },
      },
      {
        path: 'hosts',
        name: 'HostList',
        component: () => import('@/views/monitoring/HostListView.vue'),
        meta: { title: '主机监控', permission: 'monitoring.view' },
      },
      {
        path: 'hosts/:id',
        name: 'HostDetail',
    ...
    children: [
      {
        ...
        meta: { title: '报表中心', permission: 'reports.view' },
      },
    ],
  },
  {
